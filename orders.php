...
<div class="panel panel-default">
	...
	<div class="panel-body">
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Add Row </button>
			      ...
			      <button type="submit" id="createOrderBtn" onclick="myFunction()" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/fetchSelectedProduct.php" id="editOrderForm">
			  	...
			  	<tbody>
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				...
			  				<td style="padding-left:20px;">			  					
			  					<input type="text" name="quantity[]" id="quntity<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" value="<?php echo $orderItemData['quantity']; ?>" />		  					
			  					<input type="hidden" name="quantityValue[]" id="quantityValue<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $orderItemData['quantity']; ?>" />			  					
			  				</td>
			  				<td style="padding-left:20px;">
			  					<div class="form-group">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="updatePaymentOrderBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> \</button>	
      </div>           
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<script src="php_action/createOrder.php" type="text/javascript"></script>
