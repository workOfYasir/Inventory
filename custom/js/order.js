	...
	$.ajax({
		...
		success:function(response) {
			...
			var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+			  				
				...
				'</td style="padding-left:20px;">'+
				'<td style="padding-left:20px;"">'+
					'<input type="text" name="quantity[]" id="quntity'+count+'" autocomplete="off" disabled="true" class="form-control" />'+
